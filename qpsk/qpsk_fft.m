...
%disp(['Longitud esperada de symbols: ', num2str(num_symbols)]);
%disp(['Cantidad de símbolos insertados en tx_frame: ', num2str(sum(~is_pilot))]);

%disp(['Símbolos QPSK transmitidos: ', num2str(num_symbols)]);
%disp(['Símbolos recibidos después de ecualización: ', num2str(length(y_data))]);